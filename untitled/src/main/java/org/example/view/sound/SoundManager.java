...
public class SoundManager {
    ...
    private final AudioClip entradaBaseClip;
    ...
    public SoundManager() {
        ...
        entradaBaseClip = new AudioClip(getClass().getResource("/sounds/entrada_base_short.mp3").toExternalForm());
    ...
    public void playEntradaBase() { entradaBaseClip.play(); }
